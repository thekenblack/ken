...
- 훈음은 기본적으로 'Glyph'를 기준으로 하여 적지만, 구자체(Kyu; Kyujitai)가 있을 경우 구자체를 우선시하여 적는다.
	- 예를 들어 '体'이라는 한자는 정체자 기준으로 '体(용렬할 분)'이라는 훈음을 가지고 있지만, 일본어에선 거의 항상 '體(몸 체)'라는 맥락으로 사용하지, 전혀 '体(용렬할 분)'이라는 맥락으로 사용하지 않는다.
	- 따라서 '体(용렬할 분)'이라는 훈음이 사실상 일본어를 배우는 데에 아무런 도움도 안 되고, 오히려 혼란만 가중시킬 가능성이 크기 때문에, 그냥 그런 훈음은 굳이 적지 않는 것으로 하는 것이다.

| Radical | Strokes | Glyph | Kyu |   Hun    |  Eum   |         On          |  Kun<br>(Alone)  |            Kun<br>(Base)             |                Kun<br>(Kana)                |                Meaning<br>(Base-Kana)                |   Note    |
| :-----: | :-----: | :---: | :-: | :------: | :----: | :-----------------: | :--------------: | :----------------------------------: | :-----------------------------------------: | :--------------------------------------------------: | :-------: |
